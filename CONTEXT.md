...
**Stren operator**:
A person with the server-controlled platform-admin authority who runs Assisted Onboarding. Not a gym role; not stored in gym-level access.
_Avoid_: superadmin role, staff (that's a gym role)
