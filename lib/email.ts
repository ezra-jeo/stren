...
/**
 * Assisted Onboarding owner-claim invite. SMS is not implemented yet — this
 * function is the sole channel behind the small deliverClaimInvite()
 * dispatcher in lib/claim-invites.ts, so a channel can be added later
 * without touching provisioning.
 */
