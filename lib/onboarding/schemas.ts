...
export interface AccessSwitches {
  ...
  checkinRequiresMembership: boolean;
...
export const DEFAULT_ACCESS_SWITCHES: AccessSwitches = {
  ...
  checkinRequiresMembership: true,
  occupancyCount: true,
  visibility: 'private',
};
...
export function accessSwitchesToFeatureFlags(switches: AccessSwitches): Record<string, boolean> {
  return {
    ...
    auto_approve_joins: switches.autoApproveJoins,
    staff_manual_checkin: switches.staffManualCheckin,
    checkin_requires_membership: switches.checkinRequiresMembership,
...
export const provisionRequestSchema = z.object({
  ...
  switches: z.object({
    ...
    checkinRequiresMembership: z.boolean(),
