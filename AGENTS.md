...
This file is the authoritative reference for working on this codebase with Codex. Keep it up to date as the project evolves.
...
Full plan: `/root/.Codex/plans/stateless-humming-parnas.md`
