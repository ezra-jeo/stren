    ...
    return (
      <div className="space-y-3">
        ...
        <div className="flex gap-2">
          <Link href="/auth?mode=signin" className="rounded-md px-4 py-2 text-sm font-semibold" style={{ backgroundColor: 'var(--color-primary)', color: 'var(--color-white)' }}>
            Sign in
          </Link>
          <Link href="/auth?mode=signup" className="rounded-md border px-4 py-2 text-sm font-medium" style={{ borderColor: 'var(--color-surface)' }}>
            Create account
          </Link>
        </div>
      </div>
