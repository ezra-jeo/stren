export const EXPECTED_DEPLOYMENT_SCHEMA = Object.freeze({
  ...
  columns: [
    ...
    "public.rfid_cards.id", "public.rfid_cards.gym_id", "public.rfid_cards.member_id",
    "public.rfid_cards.card_digest", "public.rfid_cards.masked_id", "public.rfid_cards.status",
    "public.access_events.id", "public.access_events.gym_id", "public.access_events.member_id",
    "public.access_events.card_id", "public.access_events.attendance_id", "public.access_events.access_method",
    "public.access_events.outcome", "public.access_events.direction", "public.access_events.occurred_at",
  ...
  functions: [
    ...
    "public.kiosk_checkout(uuid, uuid)",
    "public.kiosk_checkin_by_member(uuid, uuid)",
    "public.transition_member_attendance(uuid, uuid)",
    "public.get_member_rfid_card(uuid, uuid)",
    "public.assign_member_rfid_card(uuid, text, text, uuid)",
    "public.process_rfid_tap(text, uuid)",
  ...
  rlsTables: [
    ...
    "public.rfid_cards", "public.access_events",
  ...
  grants: [
    ...
    "public.rfid_cards:authenticated:SELECT",
  ...
  functionGrants: [
    ...
    "public.get_member_rfid_card:authenticated:EXECUTE",
    "public.assign_member_rfid_card:authenticated:EXECUTE",
    "public.process_rfid_tap:authenticated:EXECUTE",
  ],
  constraints: [
    ...
    "public.rfid_cards.rfid_cards_card_digest_check",
    "public.rfid_cards.rfid_cards_status_check",
  ],
  triggers: [
    ...
    "public.access_events.access_events_immutable",
  ],
  ...
  definitionHashes: Object.freeze({
    ...
    "function:gym_feature_enabled": "893f0a8bcdaf10d79395c2692196ce38e0c2830f5428b9326910439d0cff3e36",
    "function:kiosk_checkin_by_member": "49d7bed8a52bbe007d769129009bf6cace9427bef3f2ce1e12f8dec8410fd860",
    "function:kiosk_get_occupancy": "0c9ebfb59366fc10ae9fbe12e8a66a6ae7e46cf3168bace2133a31e8b36e6d21",
    "function:get_my_access": "7d9de3f8f0018a3149c230427e1423a96ab5356fb5b9e5b1d5053fcb64b5b26b",
    "function:transition_member_attendance": "882025325295516ce2b2e54c7dd5fceaeb0717263f35079727b7e30c7b5309f3",
    "function:process_rfid_tap": "3dcdbc9fa24dc209d31c6426686de645ef3c5d05e45c632f2bbec27a084abd49",
    "function:assign_member_rfid_card": "0227ff3b244dc2740e054fa627bcf9659f8601e3c18aee4def57f408a3462a08",
    "trigger:public.access_events.access_events_immutable": "635eaa3e7cc5e47b330a003b5f43767a3823830ff7afee44a4f251d2fe4475b3",
